...
{% for section in ['home_order_position_1', 'home_order_position_2', 'home_order_position_3', 'home_order_position_4', 'home_order_position_5', 'home_order_position_6', 'home_order_position_7'] %}
    ...
    {% if section_select not in newArray %}
	    ...
	    {% if section_select == 'products' %}
	        ...
	        {#  **** Featured products ****  #}
			{% include 'snipplets/home/home-featured-products.tpl' with { 'products': sections.primary.products, 'title': settings.featured_products_title } %}

		{% elseif section_select == 'products_two' %}

	        {#  **** Featured products ****  #}
			{% include 'snipplets/home/home-featured-products.tpl' with { 'products': sections.secondary.products, 'title': settings.secondary_products_title } %}

		{% elseif section_select == 'about_us' %}
