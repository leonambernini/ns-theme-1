            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="header-account d-none d-lg-block">
                    <div class="dropdrown-box">
                        <a href="{{ store.customer_home_url }}" class="header-link-icon">
                ...
                {% if store.whatsapp or ( settings.buy_whatsapp_unique_link_active and settings.buy_whatsapp_unique_link != '' ) %}
                    <a href="{% if settings.buy_whatsapp_unique_link_active %}{{ settings.buy_whatsapp_unique_link }}{% else %}{{ store.whatsapp }}{% endif %}" target="_blank" class="header-link-icon d-none d-md-block" aria-label="{{ 'Comunicate por WhatsApp' | translate }}">
