...
.header-desktop-nav{
  ...
  .item-subitems-list-1,
  .item-subitems-banner{
    padding: 20px;
  }
  .item-subitems-banner{
    a{
...
@media( max-width: 767px ){
  .footer-navs.footer-navs-hide-mobile{
    .js-footer-mobile-box{
      padding: 0;
      margin: 0;
    }
    .js-footer-mobile-title{
      margin: 0;
      padding: 15px;
      position: relative;
      &:after{
