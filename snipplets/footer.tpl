		...
		<div class="container">
			...
			<div class="d-flex justify-content-center flex-wrap">
				...
				{% if template != 'password' %}
					...
					{# Foot Nav #}
					{% if has_footer_menu %}
						<div class="footer-navs-institucional js-footer-mobile-box">
				...
				{% if has_footer_contact_info %}
					<div class="footer-navs-contact js-footer-mobile-box">
						<h4 class="js-footer-mobile-title">
				...
				{% if has_payment_logos %}
					<div class="footer-navs-payment js-footer-mobile-box">
						<h4 class="js-footer-mobile-title">
				...
				{% if has_shipping_logos %}
					<div class="footer-navs-shipping js-footer-mobile-box">
						<h4 class="js-footer-mobile-title">
